...
# read in data
```{r}
premier_league_results_merged_fifa_rating_summary_stats <- read_csv('~/Desktop/MSBA-SA/Fall/Predictive Analytics/Project/Fifa Data Sets/premier_league_results_merged_fifa_rating_summary_stats.csv')
